            ...
            <div>
                ...
                <div class="px-6 py-6 flex items-center gap-3 border-b border-slate-800/80">
                    ...
                    <div>
                        ...
                        <p class="text-[10px] text-slate-400 tracking-wider uppercase font-semibold">PesanIn Dashboard
                        </p>
                    </div>
                </div>
                ...
                <nav class="px-4 py-6 space-y-2">
                    ...
                    @if (Auth::user()->role === 'super_admin')
                        ...
                        <a href="{{ route('admin.merchants.index') }}"
                            class="flex items-center gap-3 px-4 py-3 rounded-xl font-bold text-sm transition-all duration-200 {{ request()->routeIs('admin.merchants.*') ? 'bg-amber-500 text-slate-950 shadow-lg shadow-amber-500/30' : 'text-slate-400 hover:text-white hover:bg-slate-800/60' }}">
                    ...
                    @if (Auth::user()->role === 'owner')
                        <div class="pt-4 pb-1">
                            <p class="px-4 text-[10px] font-black uppercase tracking-wider text-slate-500">Pengaturan
                                Kafe</p>
                        </div>
            ...
            <div class="p-4 border-t border-slate-800/80">
                <div class="flex items-center justify-between bg-slate-900/80 p-3 rounded-xl border border-slate-800">
                    ...
                    <form method="POST" action="{{ route('logout') }}">
                        @csrf
                        <button type="submit" class="p-1.5 text-slate-400 hover:text-rose-400 transition"
                            title="Logout">
