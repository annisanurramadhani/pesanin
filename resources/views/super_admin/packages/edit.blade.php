...
@section('content')
    ...
    <div class="mx-auto max-w-5xl">
        ...
        @if (session('success'))
            <div
                class="mb-6 flex items-center gap-3 rounded-xl border border-emerald-200 bg-emerald-50 p-4 text-emerald-600">
                ...
                <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" id="name" name="name"
                            value="{{ old('name', strip_tags($package->name)) }}" maxlength="100" required autofocus
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" id="badge" name="badge"
                            value="{{ old('badge', strip_tags($package->badge)) }}" maxlength="50"
                    ...
                    <div class="md:col-span-2">
                        ...
                        <x-rich-text-editor name="description" label="Deskripsi" :value="old('description', $package->description)"
