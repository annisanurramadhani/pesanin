...
<div class="flex items-center gap-4">
    ...
    <div>
        ...
        <p class="mt-1 text-sm text-slate-500">
            Perbarui informasi durasi dan harga untuk paket
            ...
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xs text-slate-400">
                        Perbarui informasi durasi, harga, dan status paket.
                    </p>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input
                            ...
                            placeholder="30"
                            required
                            class="w-full rounded-xl border border-slate-200 bg-white px-4 py-3 pr-16 text-sm text-slate-800 outline-none transition placeholder:text-slate-400 focus:border-amber-500 focus:ring-4 focus:ring-amber-500/10 @error('duration_days') border-rose-500 @enderror"
                        >
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input
                            ...
                            placeholder="50000"
                            required
                            class="w-full rounded-xl border border-slate-200 bg-white px-4 py-3 pl-12 text-sm text-slate-800 outline-none transition placeholder:text-slate-400 focus:border-amber-500 focus:ring-4 focus:ring-amber-500/10 @error('price') border-rose-500 @enderror"
                        >
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input
                            ...
                            step="0.01"
                            placeholder="40000"
                            class="w-full rounded-xl border border-slate-200 bg-white px-4 py-3 pl-12 text-sm text-slate-800 outline-none transition placeholder:text-slate-400 focus:border-amber-500 focus:ring-4 focus:ring-amber-500/10 @error('discount_price') border-rose-500 @enderror"
                        >
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-xs leading-5 text-slate-500">
                                    Durasi ini merupakan bagian dari paket
