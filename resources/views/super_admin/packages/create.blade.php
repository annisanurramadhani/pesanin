...
@section('content')
    ...
    <div class="mx-auto max-w-5xl">
        ...
        <div class="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
            ...
            <form action="{{ route('super_admin.packages.store') }}" method="POST" class="p-6 package-form">
                ...
                <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <label for="badge" class="mb-2 block text-sm font-bold text-slate-700">
                            Badge
                        </label>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <x-rich-text-editor name="description" label="Deskripsi"
                            placeholder="Jelaskan apa saja yang ditawarkan paket ini..." :value="old('description')" />
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="number" id="max_qr_codes" name="max_qr_codes"
                                            value="{{ old('max_qr_codes', 5) }}" min="1" required
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="number" id="max_menus" name="max_menus"
                                            value="{{ old('max_menus', 10) }}" min="1" required
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="number" id="max_staff" name="max_staff"
                                            value="{{ old('max_staff', 2) }}" min="1" required
                        ...
                        <div class="rounded-xl border border-slate-200 bg-slate-50 p-5">
                            ...
                            <div class="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <p class="mt-1 text-xs leading-5 text-slate-500">
                                        Setelah paket berhasil dibuat, Anda dapat menambahkan dan mengatur durasi paket
                                        melalui menu Kelola Durasi.
                                    </p>
