...
<div>
    ...
    <p class="mt-1 text-sm text-slate-500">
        Perbarui informasi dan pengaturan promo berlangganan.
    </p>
</div>
...
<div class="space-y-6">
    ...
    <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div>
            ...
            <p class="mt-1 text-sm text-slate-500">
                Ubah informasi promo sesuai kebutuhan.
            </p>
        </div>
    ...
    <form
        action="{{ route(
            'super_admin.subscription_promotions.update',
    ...
    >
        ...
        <div class="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
            ...
            <div class="border-b border-slate-200 px-6 py-5">
                ...
                <p class="mt-1 text-sm text-slate-500">
                    Perbarui nama dan deskripsi promo.
                </p>
        ...
        <div class="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
            ...
            <div class="border-b border-slate-200 px-6 py-5">
                ...
                <p class="mt-1 text-sm text-slate-500">
                    Perbarui jenis dan nilai diskon.
                </p>
        ...
        <div class="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
            ...
            <div class="border-b border-slate-200 px-6 py-5">
                ...
                <p class="mt-1 text-sm text-slate-500">
                    Perbarui periode berlakunya promo.
                </p>
        ...
        <div class="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
            ...
            <div class="border-b border-slate-200 px-6 py-5">
                ...
                <p class="mt-1 text-sm text-slate-500">
                    Perbarui durasi paket yang mendapatkan promo ini.
                </p>
                            ...
                            <div class="rounded-xl border border-slate-200">
                                ...
                                <div class="grid gap-3 p-4 sm:grid-cols-2 lg:grid-cols-3">
                                    ...
                                    @foreach ($packageDurations as $duration)
                                        ...
                                        <label
                                            class="duration-option flex cursor-pointer items-start gap-3 rounded-xl border p-4 transition hover:border-amber-300 hover:bg-amber-50/30
                                            {{ in_array($duration->id, $oldDurationIds)
                        ...
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-xs text-amber-600">
                                    Tidak ada durasi paket aktif yang tersedia.
                                </p>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const discountUnit = document.getElementById(
            'discount-unit'
        );

        const discountHelp = document.getElementById(
            'discount-help'
        );
