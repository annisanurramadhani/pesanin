...
@section('content') <div class="max-w-3xl mx-auto px-4 py-8">
                ...
                <div class="text-center">
                    ...
                    @if ($order->payment_status === 'pending')
                        ...
                        @if (!empty($payment['qr_code_url']))
                            ...
                            <div class="mx-auto mt-6 flex w-fit items-center justify-center">
                                <img
                        ...
                        @else
                            ...
                            <div class="mt-6 rounded-xl border border-red-100 bg-white p-5">
                    ...
                    @elseif ($order->payment_status === 'paid')
                        ...
                        <div class="mt-6 rounded-2xl border border-emerald-100 bg-white p-6">
    ...
    @else
        ...
        <div class="mt-5 rounded-xl bg-emerald-50
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const checkInterval = setInterval(function () {
                ...
                .then(html => {
                    ...
                    /*
                     * Ambil payment status dari halaman terbaru.
                     *
                     * Jika sudah paid, reload halaman agar
                     * seluruh UI berubah mengikuti database.
                     */
                    const paymentStatus = @json($order->payment_status);

                    /*
                     * Cari teks "Lunas" pada halaman terbaru.
                     */
                    const pageText = doc.body.innerText;

                    if (
                        pageText.includes('Lunas') ||
                        pageText.includes('Pembayaran telah dikonfirmasi.')
                    ) {
