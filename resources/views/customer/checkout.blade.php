...
@section('content')
    ...
    <div class="min-h-screen bg-[#F3F4F8]">
        ...
        <div class="bg-white border-b border-slate-200">
            <div class="max-w-3xl mx-auto px-4 sm:px-6 py-5">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <a href="{{ route('customer.cart', $qrCode->code) }}"
        ...
        <div class="max-w-3xl mx-auto px-4 sm:px-6 py-6">
            ...
            @if (session('success'))
                <div class="mb-5 rounded-2xl border border-emerald-200 bg-emerald-50 px-4 py-3">
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div
                            class="w-8 h-8 rounded-lg bg-emerald-100 text-emerald-600
            ...
            @if (session('error'))
                <div class="mb-5 rounded-2xl border border-red-200 bg-red-50 px-4 py-3">
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div
                            class="w-8 h-8 rounded-lg bg-red-100 text-red-600
                                flex items-center justify-center flex-shrink-0">
            ...
            <form action="{{ route('customer.checkout.store', $qrCode->code) }}" method="POST">

                @csrf

                <input type="hidden" id="customer_token" name="customer_token">
                ...
                <div class="bg-white rounded-2xl border border-slate-200 p-5 sm:p-6">
                    ...
                    <div class="flex items-center gap-3 mb-6">
                        ...
                        <div
                            class="w-10 h-10 rounded-xl bg-amber-50 text-amber-600
                                flex items-center justify-center">
                    ...
                    <div class="mb-5">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" id="customer_name" name="customer_name" value="{{ old('customer_name') }}"
                                required maxlength="50" pattern="[a-zA-Z\s]+" title="Nama hanya boleh diisi huruf dan spasi"
                    ...
                    <div class="mb-5">
                        ...
                        <div class="relative">
                            ...
                            <input type="tel" id="customer_phone" name="customer_phone"
                                value="{{ old('customer_phone') }}" maxlength="14" placeholder="Contoh: 081234567890"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="email" id="customer_email" name="customer_email"
                                value="{{ old('customer_email') }}" maxlength="100" placeholder="Contoh: nama@email.com"
                        ...
                        <div class="flex items-start gap-2 mt-2">
                            ...
                            <i
                                class="fa-solid fa-circle-info text-[11px]
                ...
                <div class="bg-white rounded-2xl border border-slate-200 p-5 sm:p-6 mt-5">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        ...
                        <label class="cursor-pointer">
                            ...
                            <input type="radio" name="payment_method" value="bank" class="peer sr-only"
                ...
                {{-- UNTUK PILIHAN BANK  --}}
                <div id="bank-selection" class="hidden mt-4">
                    <label for="bank" class="block text-sm font-semibold text-slate-700 mb-2">
                        Pilih Bank
                        <span class="text-red-500">*</span>
                    </label>
                    ...
                    <select id="bank" name="bank"
                        ...
                        @foreach ($banks as $value => $label)
                            <option value="{{ $value }}" {{ old('bank') === $value ? 'selected' : '' }}>
                                {{ $label }}
                            </option>
                        @endforeach
                    </select>
