        ...
        <div class="bg-white rounded-2xl border border-slate-200/80 shadow-sm overflow-hidden">
            ...
            <div class="overflow-x-auto">
                ...
                <table class="w-full text-sm text-left">
                    ...
                    <tbody class="divide-y divide-slate-100" data-orders-body
                            data-orders-role="{{ Auth::user()->role }}">
                        ...
                        @forelse($orders as $order)
                            ...
                            <tr class="hover:bg-slate-50/60 transition" data-order-id="{{ $order->id }}"
                                ...
                                data-order-payment-status="{{ strtolower($order->payment_status ?? 'pending') }}"
...
<script src="{{ asset('js/merchant/orders.js') }}"></script>
