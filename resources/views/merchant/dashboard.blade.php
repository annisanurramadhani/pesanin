        ...
        <div id="dashboard-stats" class="grid grid-cols-1 gap-6 md:grid-cols-2">
            ...
            <div
                ...
                <div class="relative z-10 space-y-1">
                    ...
                    <h3 data-dashboard-today-orders class="text-4xl font-black tracking-tight text-slate-900">
            ...
            <div
                ...
                <div class="relative z-10 space-y-1">
                    ...
                    <h3 data-dashboard-today-revenue class="text-3xl font-black tracking-tight text-emerald-600">
        ...
        <div class="overflow-hidden rounded-2xl border border-slate-200/80 bg-white shadow-sm">
            ...
            <div class="overflow-x-auto">
                ...
                <table class="w-full text-left text-sm">
                    ...
                    <tbody id="dashboard-orders-body" class="divide-y divide-slate-100">
                        ...
                        @forelse($recentOrders ?? [] as $order)
                            ...
                            <tr class="transition hover:bg-slate-50/60">
                                    ...
                                    <div class="space-y-1">
                                        ...
                                        @foreach ($order->items as $item)
                                            <div class="flex items-center gap-2 text-xs">
                                                ...
                                                <span
                                                    class="rounded bg-slate-100 px-2 py-0.5 text-[10px] font-black text-slate-900">
                                                    (x{{ $item->quantity }})
                                                </span>
                                ...
                                <td class="p-4">
                                    ...
                                    @if ($isCash)
                                        <span
                                            class="inline-flex items-center gap-1.5 rounded-xl border border-slate-200/80 bg-slate-100 px-3 py-1 text-xs font-extrabold text-slate-800">
                                            <i class="fa-solid fa-cash-register text-slate-500"></i>
                                            Bayar Kasir
                                        </span>
                                    @elseif(strtolower($order->payment_method ?? '') === 'bank')
                                        <span
                                            class="inline-flex items-center gap-1.5 rounded-xl border border-blue-200/80 bg-blue-50 px-3 py-1 text-xs font-extrabold text-blue-700">
                                            <i class="fa-solid fa-building-columns text-blue-600"></i>
                                            BANK
                                        </span>
                                    @else
                                        <span
                                            class="inline-flex items-center gap-1.5 rounded-xl border border-amber-200/80 bg-amber-50 px-3 py-1 text-xs font-extrabold text-amber-700">
                                ...
                                <td class="p-4 text-center">
                                    ...
                                    <div class="flex flex-col items-center justify-center gap-1">
                                        ...
                                        @if ($order->display_status === 'completed')
                                            <span
                                                class="inline-flex items-center gap-1 rounded-lg border border-emerald-200/80 bg-emerald-50 px-2.5 py-1 text-xs font-black text-emerald-700">
                                        ...
                                        @elseif ($order->display_status === 'cancelled')
                                            <span
                                                class="inline-flex items-center gap-1 rounded-lg border border-rose-200/80 bg-rose-50 px-2.5 py-1 text-xs font-black text-rose-700">
                                        ...
                                        @elseif ($order->display_status === 'partial_problem')
                                            <span
                                                class="inline-flex items-center gap-1 rounded-lg border border-orange-200/80 bg-orange-50 px-2.5 py-1 text-xs font-black text-orange-700">
                                        ...
                                        @elseif ($order->display_status === 'processing')
                                            <span
                                                class="inline-flex items-center gap-1 rounded-lg border border-blue-200/80 bg-blue-50 px-2.5 py-1 text-xs font-black text-blue-700">
                                        ...
                                        @else
                                            <span
                                                class="inline-flex items-center gap-1 rounded-lg border border-amber-200/80 bg-amber-50 px-2.5 py-1 text-xs font-black text-amber-700">
                                    ...
                                    <div class="relative inline-block text-left" x-data="{ open: false }">
                                        ...
                                        <div x-show="open" x-transition:enter="transition ease-out duration-100"
                                            ...
                                            <a href="{{ route('merchant.orders.receipt', encryptId($order->id)) }}"
                                                ...
                                                <i class="fa-solid fa-print w-4 text-amber-500"></i>
                                            ...
                                            <a href="#"
                                                ...
                                                <i class="fa-solid fa-pen-to-square w-4 text-blue-500"></i>
...
================================================================ --}}
    ...
    <script src="{{ asset('js/merchant/dashboard.js') }}"></script>
...
================================================================ --}}
    ...
    @if (($showRenewalModal ?? false) === true)
        ...
        @php
            ...
            $hasRenewalSelection =
                !empty($renewalPackage) && !empty($renewalDuration) && session('subscription.from_public') === true;
                ...
                if (hasRenewalSelection) {
                    ...
                    Swal.fire({
                        ...
                        html:
                            ...
                            '<p style="font-size:18px;font-weight:900;color:#0f172a;margin:5px 0 0;">' +

                            packageName +

                            '</p>' +

                            '<p style="font-size:13px;font-weight:600;color:#64748b;margin:5px 0 0;">' +
                            ...
                            '<p style="font-size:20px;font-weight:900;color:#f59e0b;margin:10px 0 0;">Rp ' +
