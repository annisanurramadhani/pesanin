<@extends('layouts.app') @section('body') <div class="min-h-screen flex">
            ...
            <main class="flex-1 p-8">
                ...
                <div class="space-y-8">
                    ...
                    @if (session('error') || $errors->any())
                        <div
                            class="bg-rose-50 border border-rose-200/80 text-rose-800 px-5 py-4 rounded-2xl text-sm font-bold shadow-sm space-y-1">
                            @if (session('error'))
                                <p>{{ session('error') }}</p>
                            @endif
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                        ...
                        <div class="lg:col-span-4 bg-white p-6 rounded-2xl border border-slate-200/80 shadow-sm space-y-6">
                            ...
                            <form action="{{ route('merchant.staff.store') }}" method="POST" class="space-y-5">
                                ...
                                <div>
                                    <label
                                        class="block text-xs font-extrabold text-slate-700 uppercase tracking-wider mb-2">Nama
                                        Staf *</label>
                                ...
                                <div>
                                    <label
                                        class="block text-xs font-extrabold text-slate-700 uppercase tracking-wider mb-2">Email
                                        Login *</label>
                                ...
                                <div>
                                    <label
                                        class="block text-xs font-extrabold text-slate-700 uppercase tracking-wider mb-2">Password
                                        *</label>
                                ...
                                <div>
                                    <label
                                        class="block text-xs font-extrabold text-slate-700 uppercase tracking-wider mb-2">Tugas
                                        / Role *</label>
                                    <select name="role"
                        ...
                        <div
                            ...
                            <div class="p-6 border-b border-slate-100 flex items-center justify-between">
                                <div>
                                    ...
                                    <p class="text-xs text-slate-400 mt-0.5">Daftar karyawan yang memiliki hak akses ke
                                        sistem kafe</p>
                                </div>
                                            ...
                                            <tr class="hover:bg-slate-50/60 transition">
                                                <td class="p-4 pl-6">
                                                    <div class="flex items-center gap-3">
                                                        ...
                                                        <span
                                                            class="font-extrabold text-slate-900 text-sm">{{ $staff->name }}</span>
                                                    </div>
                                                </td>
                                                ...
                                                <td class="p-4 pr-6 text-center">
                                                    <form action="{{ route('merchant.staff.destroy', $staff->id) }}"
                                                        method="POST"
                                                        onsubmit="return confirm('Apakah Anda yakin ingin menghapus akun staf {{ $staff->name }}?');">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="submit"
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="4" class="p-12 text-center">
                                                    ...
                                                    <p class="font-bold text-slate-700 text-sm">Belum ada akun staf yang
                                                        dibuat.</p>
                                                    <p class="text-xs text-slate-400 mt-1">Gunakan form di samping untuk
                                                        menambahkan Kasir atau Dapur baru.</p>
                                                </td>
                                            </tr>
                                        @endforelse
                                    </tbody>
