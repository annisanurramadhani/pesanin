                ...
                <div class="space-y-8">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                        ...
                        <div class="lg:col-span-4 space-y-6">
                            ...
                            <div
                                class="bg-white p-6 rounded-2xl border border-slate-200/80 shadow-sm space-y-5">
                                ...
                                <div class="flex items-center gap-3 border-b border-slate-100 pb-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-[11px] font-medium text-slate-400">
                                            Misal: Coffee, Snack, Main Course
                                        </p>
                                ...
                                <form action="{{ route('merchant.category.store') }}" method="POST" class="space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            placeholder="Contoh: Coffee & Espresso"
                                            required>
                            ...
                            <div
                                ...
                                <form
                                    action="{{ route('merchant.menu.store') }}"
                                    method="POST"
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            name="name"
                                            class="w-full bg-slate-50 border border-slate-200 focus:border-amber-500 focus:bg-white focus:ring-4 focus:ring-amber-500/10 rounded-xl text-sm p-3.5 text-slate-800 font-semibold transition placeholder:font-normal placeholder:text-slate-400"
                                            placeholder="Contoh: Ice Americano PST"
                                            required>
                                    ...
                                    <div>
                                        ...
                                        <textarea
                                            ...
                                            rows="2"
                                            class="w-full bg-slate-50 border border-slate-200 focus:border-amber-500 focus:bg-white focus:ring-4 focus:ring-amber-500/10 rounded-xl text-sm p-3.5 text-slate-800 font-semibold transition placeholder:font-normal placeholder:text-slate-400"
                                            placeholder="Keterangan singkat produk..."></textarea>
                        ...
                        {{-- Main Catalogue --}}
                        <div
                            class="lg:col-span-8 bg-white rounded-2xl border border-slate-200/80 shadow-sm p-6 space-y-6">
                            ...
                            <div class="flex items-center justify-between border-b border-slate-100 pb-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-slate-400 mt-0.5">
                                        Daftar semua makanan dan minuman yang siap dipesan
                                    </p>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                ...
                                @forelse($menus as $menu)
                                    ...
                                    <div
                                        class="p-5 rounded-2xl border border-slate-200/70 bg-slate-50/50 hover:bg-white hover:border-amber-500/50 hover:shadow-md transition-all duration-200 flex flex-col justify-between group">
                                        ...
                                        <div>
                                            ...
                                            <div class="flex items-start justify-between gap-2 mb-3">
                                                ...
                                                <span
                                                    class="px-3 py-1 bg-slate-900 text-amber-400 font-extrabold rounded-lg text-[10px] uppercase tracking-wider">
                                                ...
                                                <div class="flex items-center gap-1">
                                                    ...
                                                    <a
                                                        href="{{ route('merchant.menu.edit', $menu->id) }}"
                                                    ...
                                                    <form
                                                        action="{{ route('merchant.menu.destroy', $menu->id) }}"
                                                        method="POST"
                                            ...
                                            <div class="flex gap-3 mb-3">
                                                ...
                                                @else
                                                    ...
                                                    <div
                                                        class="w-14 h-14 rounded-xl bg-slate-200/60 text-slate-400 flex items-center justify-center shrink-0 font-bold text-lg">
                                                ...
                                                <div>
                                                    ...
                                                    <h4
                                                        class="font-extrabold text-slate-900 text-base group-hover:text-amber-600 transition leading-tight">
                                        ...
                                        {{-- Footer --}}
                                        <div
                                            class="pt-3 border-t border-slate-200/60 flex items-center justify-between">
                                            ...
                                            <div class="flex items-center gap-2">
                                                ...
                                                <span
                                                    class="px-2.5 py-1 bg-slate-100 text-slate-700 rounded-xl text-[10px] font-black border border-slate-200">
                                                ...
                                                <form
                                                    action="{{ route('merchant.menu.toggle', $menu->id) }}"
                                                    method="POST">
                                ...
                                @empty
                                    ...
                                    <div class="sm:col-span-2 p-12 text-center">
                                        ...
                                        <p class="text-xs text-slate-400 mt-1">
                                            Gunakan form di samping untuk mulai menambahkan menu baru.
                                        </p>
