        ...
        <div class="flex-1 flex flex-col min-w-0 overflow-y-auto">
            ...
            <main class="flex-1 p-8">
                ...
                <div class="mx-auto max-w-2xl">
                    ...
                    <div
                        class="bg-white p-6 rounded-3xl border border-slate-200/80 shadow-sm">
                        ...
                        <form
                            ...
                            <div>
                                ...
                                @else
                                    ...
                                    <div
                                        class="mb-3 w-24 h-24 rounded-2xl bg-slate-100 border border-slate-200 flex items-center justify-center text-slate-400">
