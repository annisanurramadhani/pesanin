    ...
    <div class="space-y-6">
        ...
        <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div>
                ...
                <p class="mt-1 text-sm text-slate-500">
                    Kelola informasi dan status merchant.
                </p>
            </div>
                        ...
                        @empty
                            ...
                            <tr>
                                ...
                                <td colspan="5" class="px-6 py-16 text-center">
                                    ...
                                    <a
                                        href="{{ route('admin.merchants.create') }}"
                                        class="mt-5 inline-flex items-center gap-2 rounded-xl bg-amber-500 px-4 py-2.5 text-xs font-extrabold text-slate-950 transition hover:bg-amber-400"
                                    >
                                        <i class="fa-solid fa-plus"></i>
                                        Tambah Merchant
                                    </a>
