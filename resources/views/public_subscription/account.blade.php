...
<div class="min-h-screen bg-slate-50">
    ...
    <header class="border-b border-slate-200 bg-white">
        ...
        <div class="mx-auto flex max-w-7xl items-center justify-between px-6 py-5">
            ...
            <a
                href="{{ route('public.subscription.show', $duration->package->slug) }}"
        ...
        <div class="w-full max-w-4xl">
            ...
            <div class="mt-10 grid grid-cols-1 gap-6 md:grid-cols-2">
                ...
                >
                    ...
                    <div
                        class="mt-7 flex items-center gap-2 text-sm font-extrabold text-amber-600"
                    >
                ...
                <a
                    href="{{ route('register', ['duration' => encryptId($duration->id)]) }}"
                    class="group rounded-2xl border border-slate-200 bg-white p-8 shadow-sm transition duration-300 hover:-translate-y-1 hover:border-amber-300 hover:shadow-xl"
                >
                    ...
                    <div
                        class="mt-7 flex items-center gap-2 text-sm font-extrabold text-slate-700"
                    >
